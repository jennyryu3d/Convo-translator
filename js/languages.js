...
window.CT_UI = {
  EN: {
    ...
    slowTag: 'One moment', slowTitle: "You're going a bit fast",
    slowBody: "You've sent a lot in a short time. Please wait a moment and try again. To keep going right away, you can use your own API key.",
    quotaTag: 'Daily limit', quotaTitle: "Today's free usage is all used up",
    quotaBody: "ConvoTrans is free to use, but today's shared usage has run out. It refreshes tomorrow — or continue right now with your own API key.",
    connTag: 'Connection issue', connTitle: 'Connection is a little unstable',
    connBody: "We couldn't reach the translation server. Please try again later.",
    ...
    ok: 'OK', retry: 'Try again', useMyKey: 'Use my API key', getKeyLink: 'Get a key at console.anthropic.com →',
    ...
    shareText: 'ConvoTrans — more than a translator: it suggests what to say next so the conversation never stalls. Try it:', linkCopied: 'Message & link copied',
  ...
  KO: {
    ...
    slowTag: '잠시만요', slowTitle: '조금 빠르게 사용 중이에요',
    slowBody: '짧은 시간에 요청이 많았어요. 잠시 후 다시 시도해 주세요. 바로 계속하고 싶다면 본인 API 키를 쓸 수도 있어요.',
    quotaTag: '오늘 사용량', quotaTitle: '오늘 무료 사용량을 모두 사용했어요',
    quotaBody: 'ConvoTrans는 무료로 제공되지만, 오늘의 공용 사용량이 모두 소진됐어요. 내일 다시 충전돼요. 바로 계속하려면 본인 API 키로 번역할 수 있어요.',
    connTag: '연결 문제', connTitle: '잠시 연결이 원활하지 않아요',
    connBody: '번역 서버에 연결하지 못했어요. 잠시 후 다시 시도해 주세요.',
    ...
    ok: '확인', retry: '다시 시도', useMyKey: '내 API 키 쓰기', getKeyLink: 'console.anthropic.com에서 키 발급받기 →',
    ...
    shareText: 'ConvoTrans — 단순 번역을 넘어, 다음에 할 말까지 제안해 대화가 끊기지 않게 이어주는 번역 앱이에요. 한번 써보세요:', linkCopied: '소개 문구와 링크가 복사됐어요',
