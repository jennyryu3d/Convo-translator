...
window.CT_UI = {
  EN: {
    ...
    shareText: 'ConvoTrans — speak your language, they hear theirs. A real-time two-way conversation translator. Try it:', linkCopied: 'Message & link copied',
  ...
  KO: {
    ...
    shareText: 'ConvoTrans — 내 말은 내 언어로, 상대는 자기 언어로. 서로 다른 언어로도 바로 통하는 실시간 대화 번역기예요. 한번 써보세요:', linkCopied: '소개 문구와 링크가 복사됐어요',
